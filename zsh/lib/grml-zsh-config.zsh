...
grml_vcs_coloured_formats=(
    format "${BLUE}(${BLUE}%b${BLUE})${YELLOW} "
    actionformat "${BLUE}(${BLUE}%b${BLUE})${YELLOW} "
...
function prompt_grml_precmd () {
    ...
    left_items=(rc change-root user host path vcs percent)
...
function prompt_grml-chroot_precmd () {
    ...
    local -a left_items right_items
    left_items=(grml-chroot user host path percent)
    right_items=()
