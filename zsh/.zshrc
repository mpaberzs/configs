...
grml_vcs_coloured_formats=(
    ...
    format "${YELLOW}-${MAGENTA}[${GREEN}%b${MAGENTA}]${NO_COLOR} "
    # MYCHANGE
    # actionformat "${MAGENTA}(${NO_COLOR}%s${MAGENTA})${YELLOW}-${MAGENTA}[${GREEN}%b${YELLOW}|${RED}%a${MAGENTA}]${NO_COLOR} "
    actionformat "${YELLOW}-${MAGENTA}[${GREEN}%b${YELLOW}|${RED}%a${MAGENTA}]${NO_COLOR} "
...
[ -s "$HOME/.myzsh/rc.sh" ] && \. "$HOME/.myzsh/rc.sh"  # loads my scripts


# The next line updates PATH for the Google Cloud SDK.
if [ -f '/home/martins/google-cloud-sdk/path.zsh.inc' ]; then . '/home/martins/google-cloud-sdk/path.zsh.inc'; fi

# The next line enables shell command completion for gcloud.
if [ -f '/home/martins/google-cloud-sdk/completion.zsh.inc' ]; then . '/home/martins/google-cloud-sdk/completion.zsh.inc'; fi
