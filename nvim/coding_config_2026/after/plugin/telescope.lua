...
vim.keymap.set('n', '<leader>ff', function()
  local try_git_files = function() builtin.git_files({ show_untracked = true, use_git_root = false }); end
  local try_find_files = function() builtin.find_files({ hidden = true }); end
